...
void cpu_print_state(CPU_t* cpu) {
    ...
    // Individual Flags
    printf(" \033[1;32mZ/E\033[0m [%d]  \033[1;32mFZ\033[0m [%d]   \033[1;32mN/L\033[0m [%d]  \033[1;32mUL\033[0m  [%d]  \033[1;32mFL\033[0m\n"
          "[%d]  \033[1;32mBL\033[0m  [%d] \033[1;32mAO\033[0m  [%d]  \033[1;32mSRC\033[0m [%d]  \033[1;32mSWC\033[0m [%d]  \033[1;32mMI\033[0m  [%d]\n",
    ...
    printf("  %d    %d    %d    %d    %d    %d    %d    %d\n",
        ...
        (cpu->feature_flag & (1 << 12)) != 0,
        (cpu->feature_flag & (1 << 11)) != 0,
        (cpu->feature_flag & (1 << 10)) != 0,
    ...
    printf("  %d    %d    %d    %d    %d    %d    %d    %d\n",
        ...
        (cpu->feature_flag & (1 << 4)) != 0,
        (cpu->feature_flag & (1 << 3)) != 0,
        (cpu->feature_flag & (1 << 2)) != 0,
        (cpu->feature_flag & (1 << 1)) != 0,
        (cpu->feature_flag & (1 << 0)) != 0
    );
